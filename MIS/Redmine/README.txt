		    Bitnami RedmineCRM + Agile Stack 4.1.1-5
		  =========================================
...
RedmineCRM plus Agile plugin is a flexible project management web application. Written in Ruby on Rails freamework, it is a cross-platform and cross-database.

You can learn more about RedmineCRM at http://www.redminecrm.com

The Bitnami RedmineCRM + Agile Stack is an installer that greatly simplifies the
installation of RedmineCRM, Agile plugin and runtime dependencies. It includes ready-to-run
versions of Apache, MySQL, Subversion and Ruby on Rails. RedmineCRM + Agile Stack is 
...
Bitnami RedmineCRM + Agile Stack ships with the following software versions:
 
  - Redmine 1.5.3
  - Agile plugin 1.5.3
  - Redmine Circle theme 2.1.0
  - Apache 2.4.46
...
To install Bitnami RedmineCRM + Agile Stack you will need:
...
The Bitnami RedmineCRM + Agile Stack is distributed as a binary executable installer.
...
bitnami-redmineplusagile-4.1.1-5-linux-installer.run on Linux or
bitnami-redmineplusagile-4.1.1-5-linux-x64-installer.run on Linux 64 bits or
bitnami-redmineplusagile-4.1.1-5-windows-installer.exe on Windows or
bitnami-redmineplusagile-4.1.1-5-osx-x86-installer.dmg on OS X x86.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-redmineplusagile-4.1.1-5-linux-installer.run
...
RedmineCRM + Agile Stack at this point. If you do so, your default web browser
will point you to the Bitnami local site.

If you receive an error message during installation, please refer to
the Troubleshooting section.

The rest of this guide assumes that you installed Bitnami RedmineCRM + Agile
Stack in /home/user/redmine-4.1.1-5 on Linux or
/Application/redmine-4.1.1-5 on OS X or
C:\Program Files\Bitnami RedmineCRM + Agile Stack on Windows and use port 8080 for Apache
...
To enter to RedmineCRM plus Agile plugin website you can point your browser to
http://127.0.0.1:8080/redmineplusagile on Unix systems or http://127.0.0.1/redmineplusagile on Windows.
...
You can start and stop Bitnami RedmineCRM + Agile Stack on Windows using the shortcuts created
...
http://127.0.0.1:8080/redmineplusagile on Unix systems or

http://127.0.0.1/redmineplusagile on Windows.

If you selected an alternate port during installation, for example 18080, the
URL will look like:

http://127.0.0.1:18080/redmineplusagile
...
installation directory:
	...
	apps/redmine/htdocs: RedmineCRM and Agile plugin files.
...
This version of the Bitnami RedmineCRM + Agile Stack is a preview version, and as
...
"Cannot open bitnami-redmineplusagile-4.1.1-5-linux.run: No application suitable for 
...
$ chmod 755 bitnami-redmineplusagile-4.1.1-5-linux.run 
...
/home/user/redmineplusagile-4.1.1-5/apache2/logs/error.log on Linux or
/Applications/redmineplusagile-4.1.1-5/apache2/error.log on OS X or
C:\Program Files\Bitnami RedmineCRM + Agile Stack\apache2\logs\error.log on Windows.
...
RedmineCRM is distributed under a commercial license.
