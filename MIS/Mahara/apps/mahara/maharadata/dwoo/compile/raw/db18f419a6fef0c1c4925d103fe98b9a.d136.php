...
?>(<?php echo PluginStr($this, 'nviews', 'view', null, (is_string($tmp=(isset($this->scope["view"]["numpages"]) ? $this->scope["view"]["numpages"]:null)) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp), null, null, null);?>)<?php 
}?></span>
...
?>
                    ...
                    <?php echo $this->assignInScope(PluginProfileUrl($this, (is_string($tmp=(isset($this->scope["view"]["user"]) ? $this->scope["view"]["user"]:null)) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp), true, false), 'realauthorlink');?>
...
?>
                ...
                <a href="<?php echo PluginProfileUrl($this, (is_string($tmp=(isset($this->scope["view"]["user"]) ? $this->scope["view"]["user"]:null)) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp), true, false);?>" class="text-link">
                    <?php echo (is_string($tmp=$this->scope["view"]["sharedby"]) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp);?>
...
?>
                    ...
                    <?php echo PluginStr($this, 'Created', 'mahara', null, null, null, null, null);?>
...
?>
                    ...
                    <?php echo PluginStr($this, 'Updated', 'mahara', null, null, null, null, null);?>
...
<div class="card-body">
    <p class="lead text-small"><?php echo PluginStr($this, 'noviews1', 'view', null, null, null, null, null);?></p>
</div>
<?php 
}?>
