...
if (function_exists('PluginListTags')===false)
	$this->getLoader()->loadPlugin('PluginListTags');
...
?>
        ...
        <span class="text-small text-midtone">
            (<?php echo PluginStr($this, 'nviews', 'view', null, (is_string($tmp=(isset($this->scope["view"]["numpages"]) ? $this->scope["view"]["numpages"]:null)) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp), null, null, null);?>)
        </span>
        <?php 
}?>
...
?>
        ...
        <div class="tags">
            <strong><?php echo PluginStr($this, 'tags', 'mahara', null, null, null, null, null);?>:</strong> <?php echo PluginListTags($this, (is_string($tmp=(isset($this->scope["view"]["tags"]) ? $this->scope["view"]["tags"]:null)) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp), (is_string($tmp=(isset($this->scope["view"]["owner"]) ? $this->scope["view"]["owner"]:null)) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp), null, null);?>
