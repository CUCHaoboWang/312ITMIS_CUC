...
/* end template head */ ob_start(); /* template body */ ?><div class="card">
        <h2 class="card-header profile-block">
            ...
            <a href="<?php echo (is_string($tmp=$this->scope["sbdata"]["profileiconurl"]) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp);?>" title="<?php echo PluginStr($this, "editprofileicon", "artefact.file", null, null, null, null, null);?>" class="user-icon user-icon-60">
                <img src="<?php echo PluginProfileIconUrl($this, (is_string($tmp=(isset($this->scope["sbdata"]["id"]) ? $this->scope["sbdata"]["id"]:null)) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp), 60, 60);?>" alt="<?php echo PluginStr($this, "editprofileicon", "artefact.file", null, null, null, null, null);?>">
            </a>
        </h2>
...
?>
            ...
            <div class="list-group-item list-group-item-profile-notification">
                <?php echo PluginCleanHtml($this, (isset($this->scope["sbdata"]["mnetloggedinfrom"]) ? $this->scope["sbdata"]["mnetloggedinfrom"]:null), false);?>
...
?>
            ...
            <div id="invitedgroups" class="list-group-item list-group-item-warning list-group-item-profile-notification">
                <a href="<?php echo (is_string($tmp=$this->scope["WWWROOT"]) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp);?>group/index.php?filter=invite">
                    <span id="invitedgroupscount" class="badge badge-warning"><?php echo (is_string($tmp=$this->scope["sbdata"]["invitedgroups"]) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp);?></span>
...
?>
            ...
            <div id="pendingfriends" class="list-group-item list-group-item-warning list-group-item-profile-notification">
                <a href="<?php echo (is_string($tmp=$this->scope["WWWROOT"]) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp);?>user/index.php?filter=pending">
                    <span id="pendingfriendscount" class="badge badge-warning"><?php echo (is_string($tmp=$this->scope["sbdata"]["pendingfriends"]) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp);?></span>
...
?>
            ...
            <div id="groups" class="list-group-item">
                <div class="list-group-item-heading sidebar-item-heading"><a href="<?php echo (is_string($tmp=$this->scope["WWWROOT"]) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp);?>group/index.php"><?php echo PluginStr($this, "mygroups", 'mahara', null, null, null, null, null);?>:</a></div>
...
?><small>(<?php echo PluginStr($this, 'Admin', 'group', null, null, null, null, null);?>)</small><?php 
}?></a></li>
        <?php 
/* -- foreach end output */
	}
...
?>
            ...
            <div id="views" class="list-group-item">
                <div class="list-group-item-heading sidebar-item-heading"><a href="<?php echo (is_string($tmp=$this->scope["WWWROOT"]) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp);?>view/"><?php echo PluginStr($this, "views", 'mahara', null, null, null, null, null);?>:</a></div>
                <ul class="list-nested list-group-item-text list-unstyled list-group-item-link">
        <?php 
...
?>
            ...
            <div class="artefacts list-group-item">
                <div class="list-group-item-heading sidebar-item-heading"><?php echo PluginStr($this, "Artefacts", 'mahara', null, null, null, null, null);?>:</div>
                <ul class="list-nested list-group-item-text list-unstyled list-group-item-link">
        <?php 
...
?>
        ...
        <div id="sbdatapeer"><a href="<?php echo (is_string($tmp=$this->scope["sbdata"]["peer"]["wwwroot"]) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp);?>" class="card-body"><?php echo (is_string($tmp=$this->scope["sbdata"]["peer"]["name"]) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp);?></a></div>
    <?php 
}?>
