                    Bitnami Mahara Stack 20.10.0-0
                  ===========================
...
Mahara is a free popular web-based ePortfolio system. It is written in the
PHP scripting language and works with MySQL, MS SQL, and PostgreSQL databases
and a webserver. Mahara has been installed on Windows, Linux, Mac OS, OS/2,
and others. Almost any web browser should be able to function as a client. It
is released under the terms of the GNU General Public License (GPL).

You can learn more about Mahara at http://mahara.org

The Bitnami Mahara Stack is an installer that greatly simplifies the
installation of Mahara and runtime dependencies. It includes ready-to-run
versions of Apache, MySQL and PHP. Mahara Stack is distributed for free
...
Bitnami Mahara Stack ships with the following software:
...
To install Bitnami Mahara Stack you will need:
...
The Bitnami Mahara Stack is distributed as a binary executable installer.
...
bitnami-mahara-20.10.0-0-linux-installer.run on Linux or
bitnami-mahara-20.10.0-0-linux-x64-installer.run on Linux 64 bit or
bitnami-mahara-20.10.0-0-windows-installer.exe on Windows or
bitnami-mahara-20.10.0-0-osx-x86-installer.dmg on OS X x86.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-mahara-20.10.0-0-linux.run
...
'Installation Finished' page. You can choose to launch Bitnami Mahara
Stack at this point. If you do so, your default web browser will open and
display the Welcome page for the Bitnami Mahara Stack. 

If you received an error message during installation, please refer to
the Troubleshooting section.

The rest of this guide assumes that you installed Bitnami Mahara
Stack in /home/user/mahara-20.10.0-0 on Linux or C:\Program Files\Bitnami Mahara Stack
on Windows or /Applications/mahara-20.10.0-0 and that you use port 
8080 for Apache on Linux and port 80 on Windows and 3306 for MySQL. 

5. STARTING AND STOPPING BITNAMI MAHARA STACK
...
On Windows, you can start and stop Bitnami Mahara Stack on Windows using the shortcuts created
...
installation directory:
	...
	apps/
	  mahara/: Mahara application folder
	    conf/: Mahara Apache configuration files
	    htdocs/: Mahara PHP application files
	  phpMyAdmin/: phpMyAdmin application folder (optional)

7. DEFAULT USERNAMES AND PASSWORDS

The Mahara administrative user is admin and password are the one you set at
installation time. 

MySQL admin user is called 'root', and its password is the same as the
Mahara administrative user password.
...
This version of the Bitnami Mahara stack is a preview version, and as
...
"Cannot open bitnami-mahara-20.10.0-0-linux.run: No application suitable for
...
/home/user/mahara-20.10.0-0/apache2/logs/error.log on Linux or
C:\Program Files\Bitnami Mahara Stack\apache2\logs\error.log on Windows or
/Applications/mahara-20.10.0-0/apache2/logs/error.log.
...
For any problem related to Mahara, please visit 
https://mahara.org/
https://mahara.org/group/view.php?id=1
...
Mahara is distributed under the GNU General Public License v3,
which is located at
