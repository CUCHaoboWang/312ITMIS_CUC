                    Bitnami SuiteCRM Stack 7.11.18-0
                  ==============================
...
SuiteCRM is a software fork of the popular customer relationship management 
(CRM) system SugarCRM. SuiteCRM is SugarCRM – Supercharged! It is a free and 
open source alternative to SugarCRM Professional Edition and is based on the 
latest release of SugarCRM Community Edition 6.5 with many extra modules.

You can learn more about SuiteCRM at http://www.suitecrm.com

The Bitnami SuiteCRM Stack is an installer that greatly simplifies the
installation of SuiteCRM and runtime dependencies. It includes ready-to-run
versions of Apache, MySQL and PHP. SuiteCRM Stack is distributed for free
under the Apache 2.0 license. Please see the appendix for 
the specific licenses of all open source components included.
...
To install Bitnami SuiteCRM Stack you will need:
...
The Bitnami SuiteCRM Stack is distributed as a binary executable installer.
...
bitnami-suitecrm-7.11.18-0-linux-installer.run on Linux or
bitnami-suitecrm-7.11.18-0-linux-x64-installer.run on Linux 64 bit or
bitnami-suitecrm-7.11.18-0-windows-installer.exe on Windows or
bitnami-suitecrm-7.11.18-0-osx-x64-installer.dmg on OS X x64.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-suitecrm-7.11.18-0-linux.run
...
'Installation Finished' page. You can choose to launch Bitnami SuiteCRM
Stack at this point. If you do so, your default web browser will open and
display the Welcome page for the Bitnami SuiteCRM Stack. 

If you received an error message during installation, please refer to
the Troubleshooting section.

The rest of this guide assumes that you installed Bitnami SuiteCRM
Stack in /home/user/suitecrm-7.11.18-0 on Linux or 
C:\Bitnami\suitecrm-7.11.18-0 on Windows or 
/Applications/suitecrm-7.11.18-0 on OS X and that you use port 8080 
for Apache on Linux or port 80 on Windows and 3306 for MySQL. 

6. STARTING AND STOPPING BITNAMI SUITECRM STACK
...
On Windows, you can start and stop Bitnami SuiteCRM Stack using the shortcuts created
...
installation directory:
	...
	apps/
	  suitecrm/: SuiteCRM application folder
	    conf/: SuiteCRM Apache configuration files
	    htdocs/: SuiteCRM PHP application files
	  phpMyAdmin/: phpMyAdmin application folder (optional)

8. DEFAULT USERNAMES AND PASSWORDS

The SuiteCRM administrative user and password are the ones you set at
installation time. 

MySQL admin user is called 'root', and its password is the same as the
SuiteCRM administrative user password.
...
/home/user/suitecrm-7.11.18-0/apache2/logs/error.log on Linux or
C:\Bitnami\suitecrm-7.11.18-0\apache2\logs\error.log on Windows or
/Applications/suitecrm-7.11.18-0/apache2/logs/error.log.
...
For any problem related to SuiteCRM, please visit 
...
SuiteCRM is distributed under the GNU Affero General Public License v3,
which is located at https://www.gnu.org/licenses/agpl.html
