...
bitnami-orangehrm-4.6-0-linux-installer.run on Linux or
bitnami-orangehrm-4.6-0-linux-x64-installer.run on Linux 64 bit or
bitnami-orangehrm-4.6-0-windows-installer.exe on Windows or
bitnami-orangehrm-4.6-0-osx-x64-installer.dmg on OS X x64.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-orangehrm-4.6-0-linux.run
...
Stack in /home/user/orangehrm-4.6-0 on Linux or 
C:\Bitnami\orangehrm-4.6-0 or 
/Applications/orangehrm-4.6-0 on OS X and that 
...
/home/user/orangehrm-4.6-0/apache2/logs/error.log on Linux or
C:\Program Files\Bitnami OrangeHRM Stack\apache2\logs\error.log on Windows or
/Applications/orangehrm-4.6-0/apache2/logs/error.log.
