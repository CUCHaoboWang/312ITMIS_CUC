@ECHO OFF
									SET "PHP_PEAR_SYSCONF_DIR=C:\xampp\htdocs\MIS\OrangeHRM\php"
...
FOR %%x IN ("C:\xampp\htdocs\MIS\OrangeHRM\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\xampp\htdocs\MIS\OrangeHRM\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\xampp\htdocs\MIS\OrangeHRM\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\xampp\htdocs\MIS\OrangeHRM\php\php.exe"
