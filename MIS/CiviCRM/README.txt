                    Bitnami CiviCRM Stack 5.31.0-0
                  ===================================
...
CiviCRM is an open source and freely downloadable constituent relationship
management solution. CiviCRM is web-based, open source, internationalized,
and designed specifically to meet the needs of advocacy, non-profit and
non-governmental groups. Integration with both Drupal and Joomla! content
management systems gives you the tools to connect, communicate and activate
your supporters and constituents.

You can learn more about CiviCRM at http://civicrm.org

The Bitnami CiviCRM Stack is an installer that greatly simplifies the
installation of CiviCRM and runtime dependencies. It includes ready-to-run
versions of Apache, MySQL and PHP. CiviCRM Stack is distributed for free
...
Bitnami CiviCRM Stack ships with the following:
...
To install Bitnami CiviCRM Stack you will need:
...
The Bitnami CiviCRM Stack is distributed as a binary executable installer.
...
bitnami-civicrm-5.31.0-0-linux-installer.run on Linux or
bitnami-civicrm-5.31.0-0-linux-x64-installer.run on Linux or
bitnami-civicrm-5.31.0-0-windows-installer.exe on Windows or
bitnami-civicrm-5.31.0-0-osx-x86-installer.dmg on OS X x86 or
bitnami-civicrm-5.31.0-0-osx-x86_64-installer.dmg on OS X x64.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-civicrm-5.31.0-0-linux.run
...
'Installation Finished' page. You can choose to launch Bitnami CiviCRM
Stack at this point. If you do so, your default web browser will open and
display the Welcome page for the Bitnami CiviCRM Stack. 

If you received an error message during installation, please refer to
the Troubleshooting section.

The rest of this guide assumes that you installed Bitnami CiviCRM
Stack in /home/user/civicrm-5.31.0-0 on Linux or C:\Program Files\Bitnami CiviCRM Stack
on Windows or /Applications/civicrm-5.31.0-0 on OS X and that you use port 
8080 for Apache on Linux and port 80 on Windows and 3306 for MySQL. 

5. STARTING AND STOPPING BITNAMI CIVICRM STACK
...
On Windows, you can start and stop Bitnami CiviCRM Stack on Windows using the shortcuts created
...
installation directory:
	...
	apps/
	  civicrm/: CiviCRM application folder
	    conf/: CiviCRM Apache configuration files
	    htdocs/: CiviCRM PHP application files
	  phpMyAdmin/: phpMyAdmin application folder (optional)

7. DEFAULT USERNAMES AND PASSWORDS

The CiviCRM administrative user and password are the ones you set at
installation time. 

MySQL admin user is called 'root', and its password is the same as the
CiviCRM administrative user password.
...
This version of the Bitnami CiviCRM stack is a preview version, and as
...
"Cannot open bitnami-civicrm-5.31.0-0-linux.run: No application suitable for
...
/home/user/civicrm/apache2/logs/error.log on Linux or
C:\Program Files\Bitnami CiviCRM Stack\apache2\logs\error.log on Windows or
/Applications/civicrm-5.31.0-0/apache2/logs/error.log.
...
For any problem related to CiviCRM, please visit 
http://civicrm.org
...
CiviCRM is distributed under the GNU Affero General Public License v3,
which is located at
http://www.gnu.org/licenses/agpl-3.0.txt
with an exception located at
https://github.com/civicrm/civicrm-core/blob/master/agpl-3.0.exception.txt
